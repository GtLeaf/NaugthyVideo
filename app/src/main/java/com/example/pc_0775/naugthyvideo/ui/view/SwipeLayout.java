package com.example.pc_0775.naugthyvideo.ui.view;
...
/**
 * Created by PC-0775 on 2018/10/20.
 */
...
public class SwipeLayout extends FrameLayout {
    ...
    * */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()){
            case MotionEvent.ACTION_UP:
                ...
                if (SwipeState.CLOSE == swipeState) {
    ...
    protected void onFinishInflate() {
        ...
        if (childCount < 2) {
            throw new IllegalArgumentException("You must have 2 children at least!! 你得有 至少两个子view！！");
        }
        //2 校验都是viewGroup
        if (null == getChildAt(0) || !(getChildAt(0) instanceof ViewGroup) ||
                null == getChildAt(1) || !(getChildAt(1) instanceof ViewGroup)) {
            throw new IllegalArgumentException("your child must be instance of ViewGroup! 你的view 必须是 viewgroup 的子类 ");
        }

        //  后边菜单
        mBackLayout = (ViewGroup) findViewById(R.id.ll_swipe_collection_back);
        //前置条目
        mFrontLayout  = (ViewGroup) findViewById(R.id.rl_swipe_collection_front);
    }
